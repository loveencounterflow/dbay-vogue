(function() {
  ...
  this.Vogue_scraper_ABC = class Vogue_scraper_ABC extends Vogue_common_mixin() {
    ...
    html_from_details(row) {
      ...
      var details, dsk, dsk_html, pid, pid_html, rank, rank_html, sid, sid_html, sparkline_data, tds, title_html, ts, ts_html;
      ({sid, dsk, ts, pid, rank, sparkline_data, details} = row);
      //.......................................................................................................
      ...
      tds = [
        ...
        {
          'data-sparkline_data': sparkline_data
        }),
    ...
    _XXX_get_details_chart() {
      var R, sparkline_data_json;
      R = [];
      sparkline_data_json = this.hub.vdb.get_latest_sparkline_data_json();
      R.push(HDML.pair('div.trendchart', {
        'data-trends': sparkline_data_json
      }));
      return R.join('\n');
    }
    ...
    _XXX_get_details_table() {
      ...
      ref = this.hub.vdb.db(`select * from scr_latest_trends_html;`);
      //.......................................................................................................
