(function() {
  ...
  this.Vogue_scraper_ABC = class Vogue_scraper_ABC extends Vogue_common_mixin() {
    ...
    html_from_details(row) {
      var details, dsk, dsk_html, pid, pid_html, rank, rank_html, sid, sid_html, tds, title_html, trend, trend_json, ts, ts_html;
    ...
    _XXX_get_details_chart() {
      var R, trends, trends_json;
      R = [];
      trends = this.hub.vdb.get_latest_trends();
