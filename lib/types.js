(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('vogue_constructor_cfg', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
      "@isa.object x.client": function(x) {
        return this.isa.object(x.client);
      },
  ...
  //...........................................................................................................
  this.defaults.vogue_constructor_cfg = {
    db: null,
    prefix: 'scr'
  };
  ...
  this.types.declare('vogue_scraper_constructor_cfg', {
    tests: {
      ...
      "@isa.vogue x.vogue": function(x) {
        return this.isa.vogue(x.vogue);
      }
    }
  });
