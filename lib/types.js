(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('vogue_scheduler_unit', {
    tests: {
      "@isa.nonempty_text x": function(x) {
        return this.isa.object(x);
      },
      "x is singular or plural week, day, hour, minute, second": function(x) {
        if (x === 'week') {
          return true;
        }
        if (x === 'day') {
  ...
  this.types.declare('vogue_scheduler_add_interval_cfg', {
    tests: {
      ...
      "( @isa.function x.callee ) or ( @isa.asyncfunction x.callee )": function(x) {
        return (this.isa.function(x.callee)) || (this.isa.asyncfunction(x.callee));
      },
      "@isa.positive_float x.amount": function(x) {
        return this.isa.positive_float(x.amount);
      },
      "@isa.vogue_scheduler_unit": function(x) {
        return this.isa.vogue_scheduler_unit;
      }
    }
  });
