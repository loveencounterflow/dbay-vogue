(function() {
  ...
  this.types.declare('vogue_db_as_html_cfg', {
    tests: {
      ...
      "@isa_optional.nonempty_text x.table": function(x) {
        return this.isa_optional.nonempty_text(x.table);
      },
      "@isa_optional.notunset x.query": function(x) {
        return this.isa_optional.notunset(x.query);
      },
      "must have one of x.table, x.query": function(x) {
        return ((x.table != null) && (x.query == null)) || ((x.query != null) && (x.table == null));
      },
      "@isa.vogue_db_use_fields x.keys": function(x) {
        return this.isa.vogue_db_use_fields(x.keys);
      },
      ...
      "@isa.nonempty_text x.class": function(x) {
        return this.isa.nonempty_text(x.class);
      }
    }
  });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('vogue_db_use_fields', {
    tests: {
