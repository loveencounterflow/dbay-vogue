(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('vogue_scheduler_duration', {
    tests: {
      "@isa.nonempty_text x": function(x) {
        return this.isa.nonempty_text(x);
      },
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.types.declare('vogue_scheduler_ar_duration', function(x) {
    if (this.isa.vogue_scheduler_duration(x)) {
      return true;
    }
    if (this.isa.vogue_scheduler_percentage(x)) {
      return true;
    }
    return false;
  });
  ...
  this.types.declare('vogue_scheduler_add_interval_cfg', {
    tests: {
      ...
      "@isa.vogue_task x.task": function(x) {
        return this.isa.vogue_task(x.task);
      },
      "@isa.vogue_scheduler_duration x.repeat": function(x) {
        return this.isa.vogue_scheduler_duration(x.repeat);
      },
      "@isa.vogue_scheduler_duration x.jitter": function(x) {
        return this.isa.vogue_scheduler_duration(x.jitter);
      },
      "@isa.vogue_scheduler_ar_duration x.timeout": function(x) {
        return this.isa.vogue_scheduler_duration(x.timeout);
      },
      "@isa.vogue_scheduler_duration x.pause": function(x) {
        return this.isa.vogue_scheduler_duration(x.pause);
      }
    }
  });
