(function() {
  'use strict';
  var CND, HTTP, Koa, PATH, Router, Socket_server, app, badge, debug, echo, file_server, file_server_cfg, help, http_server, info, io, paths, router, rpr, server_cfg, urge, warn, whisper;
