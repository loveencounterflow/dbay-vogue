...
insert into ${prefix}_posts ( sid, pid, rank, details )
  ...
  from ${prefix}_trends where true
    ...
    _table_as_html(cfg) {
      ...
      var R, as_html, details, field, fields, format, i, inner_html, is_done, j, key, keys, len, len1, raw_value, ref1, ref2, ref3, ref4, ref5, ref6, row, row_nr, statement, table, table_i, title, value;
      ({table, fields} = cfg);
      keys = null;
      R = [];
