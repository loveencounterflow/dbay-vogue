...
insert into ${prefix}_posts ( sid, pid, rank, details )
  ...
  from ${prefix}_trends where true
    ...
    _table_as_html(cfg) {
      ...
      var R, as_html, details, field, fields, has_ths, i, inner_html, is_done, key, keys, len, push_table_headers, raw_value, ref1, ref2, ref3, ref4, ref5, row, row_nr, rows, value;
      ({rows, fields} = cfg);
      fields = {...fields};
      ...
      for (row of rows) {
        ...
        for (i = 0, len = keys.length; i < len; i++) {
          ...
          if (field != null) {
            ...
            if ((as_html = (ref4 = field.outer_html) != null ? ref4 : null) != null) {
              is_done = true;
              R.push(as_html(value, details));
            } else if ((as_html = (ref5 = field.inner_html) != null ? ref5 : null) != null) {
