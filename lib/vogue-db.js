...
insert into ${prefix}_posts ( sid, pid, rank, details )
  ...
  from ${prefix}_trends where true
    ...
    _table_as_html(cfg) {
      ...
      var R, as_html, details, field, fields, format, i, inner_html, is_done, j, key, keys, len, len1, parameters, query, raw_value, ref1, ref2, ref3, ref4, ref5, row, row_nr, rows, title, value;
      ({query, parameters, fields} = cfg);
      if (parameters == null) {
        parameters = {};
      }
      keys = null;
      ...
      for (row of rows) {
        ...
        for (j = 0, len1 = keys.length; j < len1; j++) {
          ...
          if (field != null) {
            ...
            if ((format = (ref3 = field.format) != null ? ref3 : null) != null) {
