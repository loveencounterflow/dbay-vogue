  ...
  from ${prefix}_trends where true
    ...
    as_html(cfg) {
      ...
      if (cfg.table != null) {
        ...
        cfg.rows = this.db(cfg.query, (ref1 = cfg.parameters) != null ? ref1 : {});
    ...
    _table_as_html(cfg) {
      ...
      var R, as_html, details, field, fields, format, i, inner_html, is_done, j, key, keys, len, len1, raw_value, ref1, ref2, ref3, ref4, ref5, ref6, ref7, row, row_nr, rows, title, value;
      ({rows, fields} = cfg);
      fields = {...fields};
      if ((function() {
        var results;
...
//.......................................................................................................
      for (row of rows) {
        ...
        for (j = 0, len1 = keys.length; j < len1; j++) {
          ...
          raw_value = row[key];
          value = raw_value;
          field = (ref2 = fields[key]) != null ? ref2 : null;
          if (value === void 0) {
            value = (ref3 = (ref4 = field != null ? field.undefined : void 0) != null ? ref4 : cfg.undefined) != null ? ref3 : 'undefined';
          }
          is_done = false;
          inner_html = null;
          if (field != null) {
            ...
            if ((format = (ref5 = field.format) != null ? ref5 : null) != null) {
              value = format(value, details);
            }
            if ((as_html = (ref6 = field.outer_html) != null ? ref6 : null) != null) {
              is_done = true;
              R.push(as_html(value, details));
            } else if ((as_html = (ref7 = field.inner_html) != null ? ref7 : null) != null) {
