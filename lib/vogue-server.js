(function() {
  'use strict';
  var CND, FS, GUY, H, HTTP, Koa, PATH, Router, Socket_server, Vogue_common_mixin, badge, debug, echo, file_server, help, info, mount, ref, rpr, urge, warn, whisper,
