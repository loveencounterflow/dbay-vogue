(function() {
  'use strict';
  var CND, FS, GUY, H, HDML, HTTP, Koa, PATH, Router, SQL, Socket_server, Vogue_common_mixin, badge, debug, echo, file_server, help, info, mount, ref, rpr, urge, warn, whisper,
  ...
  ref = this.Vogue_server = class Vogue_server extends Vogue_common_mixin() {
    ...
    _r_trends(ctx) {
      ...
      var R, dsk, parameters, query, ref1, ref2, scraper, table_name_i, trends_table_name, x;
      boundMethodCheck(this, ref);
      R = [];
    ...
    _query_as_html(table, query, parameters) {
      ...
      return this.hub.vdb.as_html({query, parameters, ...table_cfg});
    }
