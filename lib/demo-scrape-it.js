(function() {
  ...
  Hnrss = class Hnrss {
    ...
    get_html_for_trends(d) {
      ...
      var dsk, dsk_html, id, id_html, rank, rank_html, ref, row, sid, sid_html, sql, tds/* TAINT use proper way to shorten string */, title_html, tr, trend, trend_html, ts, ts_html;
      help('^44364561^', d);
      return "<xxx/>";
