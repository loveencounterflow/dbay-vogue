(function() {
  ...
  Hnrss = class Hnrss {
    ...
    scrape_html(html_or_buffer) {
      ...
      var $, R, article_url, creator, d, date, description, discussion_url, dsk, href, html, i, insert_post, item, len, pid, ref, row, seen, sid, title;
      dsk = 'hn';
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        d = JSON.stringify(d);
        row = this.scr.new_post({sid, pid, d});
      }
      //.......................................................................................................
    ...
    get_html_for_trends(row) {
      var d, dsk, dsk_html, id_html, pid, rank, rank_html, sid, sid_html, tds, title_html, trend, trend_html, ts, ts_html;
      ({dsk, sid, ts, pid, rank, trend, d} = row);
      //.......................................................................................................
