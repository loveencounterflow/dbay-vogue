(function() {
  'use strict';
  var CHEERIO, CND, DBay, FS, GUY, H, Hnrss, PATH, SQL, Scraper, badge, debug, demo_1, demo_hnrss, demo_zvg24_net, demo_zvg_online_net, echo, got, help, info, rpr, types, urge, warn, whisper;
  ...
  Hnrss = class Hnrss {
    ...
    scrape_html(html_or_buffer) {
      ...
      var $, R, article_url, creator, d, date, description, discussion_url, dsk, href, html, i, id, insert_post, item, len, ref, round, row, seen, title;
      ({round} = this.scr.new_round());
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        d = JSON.stringify(d);
        row = this.scr.new_post({dsk, id, round, d});
      }
      //.......................................................................................................
...
order by round, seq;`));
  ...
  demo_hnrss = async function() {
    ...
    //.........................................................................................................
    H.tabulate("progressions", hnrss.scr.db(SQL`select distinct
    id                                                  as id,
