(function() {
  'use strict';
  var CHEERIO, CND, DBay, FS, GUY, H, Hnrss, PATH, SQL, Xxxx, badge, debug, demo_1, demo_hnrss, demo_zvg24_net, demo_zvg_online_net, echo, got, help, info, rpr, types, urge, warn, whisper;
  ...
  Xxxx = class Xxxx {
    //---------------------------------------------------------------------------------------------------------
    constructor(cfg) {
      GUY.props.hide(this, 'db', new DBay());
  ...
  Hnrss = class Hnrss {
    ...
    scrape_html(html_or_buffer) {
      var $, R, article_url, creator, date, description, discussion_url, href, html, i, id, item, len, ref, title;
